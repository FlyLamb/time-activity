...
public class EnemyController : MonoBehaviour {
    ...
    private Vector2 eInput; // emulated input
    private bool eJump = false;

    public void SetInput(Vector2 inputLocalSpace) {
        eInput = inputLocalSpace;
    }

    public void SetJump(bool f) {
        eJump = f;
    }

    public void SetInput(Vector3 inputGlobalSpace) {
        var a = transform.InverseTransformDirection(inputGlobalSpace);
        SetInput(new Vector2(a.x,a.z));
    }
